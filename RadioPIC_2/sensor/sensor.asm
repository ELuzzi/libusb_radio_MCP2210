...
;sensor.c,1110 :: 		if(trans == 0){
	...
	BTFSS       STATUS+0, 2 
	GOTO        L_main186
;sensor.c,1111 :: 		if(Debounce_INT() == 0 ){
	CALL        _Debounce_INT+0, 0
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main187
;sensor.c,1112 :: 		temp1 = read_ZIGBEE_short(INTSTAT); // Read and flush register INTSTAT
	MOVLW       49
	MOVWF       FARG_read_ZIGBEE_short_address+0 
	CALL        _read_ZIGBEE_short+0, 0
	MOVF        R0, 0 
	MOVWF       _temp1+0 
;sensor.c,1113 :: 		read_RX_FIFO();                     // Read receive data
	CALL        _read_RX_FIFO+0, 0
;sensor.c,1115 :: 		d2=DATA_RX[1];
	MOVF        _DATA_RX+1, 0 
	MOVWF       main_d2_L0+0 
;sensor.c,1116 :: 		d3=DATA_RX[2];
	MOVF        _DATA_RX+2, 0 
	MOVWF       main_d3_L0+0 
;sensor.c,1121 :: 		Lcd_Chr(1, 1, d1);
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_column+0 
...
;sensor.c,1146 :: 		}
L_main187:
;sensor.c,1147 :: 		} //final trans = 0
L_main186:
;sensor.c,1148 :: 		if(trans == 1){
	MOVF        main_trans_L0+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_main188
;sensor.c,1150 :: 		delay_ms(1000);
	MOVLW       13
	MOVWF       R11, 0
	MOVLW       175
	MOVWF       R12, 0
...
L_main189:
	...
	BRA         L_main189
	NOP
;sensor.c,1152 :: 		DATA_TX[0]=dig1;
	MOVF        _dig1+0, 0 
	MOVWF       _DATA_TX+0 
;sensor.c,1153 :: 		DATA_TX[1]=dig2;
	MOVF        _dig2+0, 0 
	MOVWF       _DATA_TX+1 
;sensor.c,1154 :: 		DATA_TX[2]=dig3;
	MOVF        _dig3+0, 0 
	MOVWF       _DATA_TX+2 
;sensor.c,1155 :: 		DATA_TX[3]=degrees;
	MOVF        _degrees+0, 0 
	MOVWF       _DATA_TX+3 
;sensor.c,1156 :: 		DATA_TX[4]=battery;
	MOVF        _battery+0, 0 
	MOVWF       _DATA_TX+4 
;sensor.c,1157 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;sensor.c,1158 :: 		i = read_ZIGBEE_short(TXSTAT);
	MOVLW       36
	MOVWF       FARG_read_ZIGBEE_short_address+0 
	CALL        _read_ZIGBEE_short+0, 0
;sensor.c,1159 :: 		IntToStr(i, texto);
	MOVF        R0, 0 
	...
	CALL        _IntToStr+0, 0
;sensor.c,1160 :: 		Lcd_Out(1,1,texto);
	MOVLW       1
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
...
L_main190:
	...
	BRA         L_main190
	NOP
;sensor.c,1164 :: 		DATA_TX[0]='3';
	MOVLW       51
	MOVWF       _DATA_TX+0 
;sensor.c,1165 :: 		DATA_TX[1]='4';
	MOVLW       52
	MOVWF       _DATA_TX+1 
;sensor.c,1166 :: 		DATA_TX[2]='5';
	MOVLW       53
	MOVWF       _DATA_TX+2 
;sensor.c,1167 :: 		DATA_TX[3]=degrees;
	MOVF        _degrees+0, 0 
	MOVWF       _DATA_TX+3 
;sensor.c,1168 :: 		DATA_TX[4]=battery;
	MOVF        _battery+0, 0 
	MOVWF       _DATA_TX+4 
;sensor.c,1169 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;sensor.c,1170 :: 		i = read_ZIGBEE_short(TXSTAT);
	MOVLW       36
	MOVWF       FARG_read_ZIGBEE_short_address+0 
	CALL        _read_ZIGBEE_short+0, 0
;sensor.c,1171 :: 		IntToStr(i, texto);
	MOVF        R0, 0 
	MOVWF       FARG_IntToStr_input+0 
	MOVLW       0
	BTFSC       R0, 7 
	...
	MOVWF       FARG_IntToStr_output+1 
	CALL        _IntToStr+0, 0
;sensor.c,1172 :: 		Lcd_Out(1,1,texto);
	MOVLW       1
	MOVWF       FARG_Lcd_Out_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Out_column+0 
	...
	MOVWF       FARG_Lcd_Out_text+1 
	CALL        _Lcd_Out+0, 0
;sensor.c,1173 :: 		}   //final trans ==1
L_main188:
;sensor.c,1175 :: 		}//final while
	GOTO        L_main184
;sensor.c,1176 :: 		}
	GOTO        $+0
; end of _main
