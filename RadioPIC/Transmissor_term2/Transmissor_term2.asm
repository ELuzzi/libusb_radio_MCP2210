...
L_write_TX_normal_FIFO5:
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__write_TX_normal_FIFO225
	MOVLW       18
	SUBWF       write_TX_normal_FIFO_i_L0+0, 0 
L__write_TX_normal_FIFO225:
	BTFSC       STATUS+0, 0 
...
;Transmissor_term2.c,1104 :: 		Initialize();                      // Initialize MCU and Bee click board
	CALL        _Initialize+0, 0
;Transmissor_term2.c,1106 :: 		while(1) {
L_main184:
;Transmissor_term2.c,1108 :: 		if(trans == 0){
	MOVLW       0
...
L__main227:
	BTFSS       STATUS+0, 2 
	GOTO        L_main186
;Transmissor_term2.c,1109 :: 		if(Debounce_INT() == 0 ){
	CALL        _Debounce_INT+0, 0
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main187
;Transmissor_term2.c,1110 :: 		temp1 = read_ZIGBEE_short(INTSTAT); // Read and flush register INTSTAT
	MOVLW       49
	MOVWF       FARG_read_ZIGBEE_short_address+0 
	CALL        _read_ZIGBEE_short+0, 0
	MOVF        R0, 0 
	MOVWF       _temp1+0 
;Transmissor_term2.c,1111 :: 		read_RX_FIFO();                     // Read receive data
	CALL        _read_RX_FIFO+0, 0
;Transmissor_term2.c,1112 :: 		dig1=DATA_RX[0];
	MOVF        _DATA_RX+0, 0 
	MOVWF       _dig1+0 
;Transmissor_term2.c,1113 :: 		dig2=DATA_RX[1];
	MOVF        _DATA_RX+1, 0 
	MOVWF       _dig2+0 
;Transmissor_term2.c,1114 :: 		dig3=DATA_RX[2];
	MOVF        _DATA_RX+2, 0 
	MOVWF       _dig3+0 
;Transmissor_term2.c,1115 :: 		degrees=DATA_RX[3];
	MOVF        _DATA_RX+3, 0 
	MOVWF       _degrees+0 
;Transmissor_term2.c,1116 :: 		battery=DATA_RX[4];
	MOVF        _DATA_RX+4, 0 
	MOVWF       _battery+0 
;Transmissor_term2.c,1118 :: 		Lcd_Chr(1, 1, dig1);
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;Transmissor_term2.c,1119 :: 		Lcd_Chr(1, 2, dig2);
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;Transmissor_term2.c,1120 :: 		if ((dig3 == 'i')||(dig3 == 'o')){
	MOVF        _dig3+0, 0 
	XORLW       105
	BTFSC       STATUS+0, 2 
	GOTO        L__main213
	...
	GOTO        L_main190
L__main213:
;Transmissor_term2.c,1121 :: 		Lcd_Chr(1, 3, dig3);
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       3
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;Transmissor_term2.c,1122 :: 		Lcd_Chr(1, 4, ' ');
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       4
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;Transmissor_term2.c,1123 :: 		}
	GOTO        L_main191
L_main190:
;Transmissor_term2.c,1125 :: 		Lcd_Chr(1, 3, '.');
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       3
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;Transmissor_term2.c,1126 :: 		Lcd_Chr(1, 4, dig3);
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       4
	MOVWF       FARG_Lcd_Chr_column+0 
...
L_main191:
;Transmissor_term2.c,1129 :: 		if (battery == 'b'){
	MOVF        _battery+0, 0 
	XORLW       98
	BTFSS       STATUS+0, 2 
	GOTO        L_main192
;Transmissor_term2.c,1130 :: 		Lcd_Out(2, 0, "           ");
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	CLRF        FARG_Lcd_Out_column+0 
...
;Transmissor_term2.c,1131 :: 		}
	GOTO        L_main193
L_main192:
;Transmissor_term2.c,1133 :: 		Lcd_Out(2, 0, "low battery");
	MOVLW       2
	MOVWF       FARG_Lcd_Out_row+0 
	CLRF        FARG_Lcd_Out_column+0 
...
L_main193:
;Transmissor_term2.c,1136 :: 		if (degrees == 'C'){
	MOVF        _degrees+0, 0 
	XORLW       67
	BTFSS       STATUS+0, 2 
	GOTO        L_main194
;Transmissor_term2.c,1137 :: 		Lcd_Chr(1, 5, 'C');
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       5
	MOVWF       FARG_Lcd_Chr_column+0 
...
;Transmissor_term2.c,1138 :: 		}
	GOTO        L_main195
L_main194:
;Transmissor_term2.c,1140 :: 		Lcd_Chr(1, 5, ' ');
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       5
	MOVWF       FARG_Lcd_Chr_column+0 
