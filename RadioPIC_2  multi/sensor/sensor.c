...
void main() {
     ...
     short int i, cont = 0, cond=0, lost = 0, lostT = 0, ch_cont = 0, bestChannel = 0xFF; //ch_cont caso fique muito tempo sem conseguir comunicar, volta para o canal 11. Variável bestChannel, guarda o canal com menor ruido
     int sleep = 4;
     char texto[16];
     ...
     while(1) {
              ...
              if(trans == 0){
                      ...
                      if(Debounce_INT() == 0 ){
                              ...
                              //verifica qual é o melhor canal (com menor ruido)
