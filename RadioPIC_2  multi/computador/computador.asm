...
L__write_ZIGBEE_long100:
	...
	BSF         R1, 7 
	ADDLW       255
	GOTO        L__write_ZIGBEE_long100
L__write_ZIGBEE_long101:
	MOVLW       127
	ANDWF       R0, 0 
	MOVWF       FARG_SPI1_Write_data_+0 
...
;computador.c,197 :: 		address_low  = (((short int)(address << 5)) & 0b11100000) | 0x10;  // calculating addressing mode
	...
	MOVF        R0, 0 
L__write_ZIGBEE_long102:
	BZ          L__write_ZIGBEE_long103
	RLCF        write_ZIGBEE_long_address_low_L0+0, 1 
	BCF         write_ZIGBEE_long_address_low_L0+0, 0 
	ADDLW       255
	GOTO        L__write_ZIGBEE_long102
L__write_ZIGBEE_long103:
	MOVLW       224
...
L__read_ZIGBEE_long104:
	...
	BSF         R1, 7 
	ADDLW       255
	GOTO        L__read_ZIGBEE_long104
L__read_ZIGBEE_long105:
	MOVLW       127
	ANDWF       R0, 0 
	MOVWF       FARG_SPI1_Write_data_+0 
	BSF         FARG_SPI1_Write_data_+0, 7 
;computador.c,213 :: 		address_low  = ((short int)(address << 5) & 0b11100000);         //calculating addressing mode
	...
	MOVF        R0, 0 
L__read_ZIGBEE_long106:
	BZ          L__read_ZIGBEE_long107
	RLCF        read_ZIGBEE_long_address_low_L0+0, 1 
	BCF         read_ZIGBEE_long_address_low_L0+0, 0 
	ADDLW       255
	GOTO        L__read_ZIGBEE_long106
L__read_ZIGBEE_long107:
	MOVLW       224
...
L_write_TX_normal_FIFO5:
	...
	SUBWF       R0, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__write_TX_normal_FIFO111
	MOVLW       29
	SUBWF       write_TX_normal_FIFO_i_L0+0, 0 
L__write_TX_normal_FIFO111:
	BTFSC       STATUS+0, 0 
...
;computador.c,796 :: 		set_channel(ch);     // Channel 11
	MOVF        _ch+0, 0 
	MOVWF       FARG_set_channel_channel_number+0 
...
;computador.c,893 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;computador.c,897 :: 		while(1) {
L_main72:
;computador.c,899 :: 		if(cond3 == 62){
	MOVLW       0
...
L__main112:
	BTFSS       STATUS+0, 2 
	GOTO        L_main74
;computador.c,900 :: 		if(trans == 2){
	MOVF        main_trans_L0+0, 0 
	XORLW       2
	BTFSS       STATUS+0, 2 
	GOTO        L_main75
;computador.c,901 :: 		EEPROM_Write(addr, SEQ_NUMBER);
...
;computador.c,902 :: 		}
	GOTO        L_main76
L_main75:
;computador.c,904 :: 		EEPROM_Write(addr, 0xF0);
	MOVF        main_addr_L0+0, 0 
	MOVWF       FARG_EEPROM_Write_address+0 
	MOVLW       240
	MOVWF       FARG_EEPROM_Write_data_+0 
...
;computador.c,905 :: 		}
L_main76:
;computador.c,907 :: 		cond3 = 0;
	CLRF        main_cond3_L0+0 
	CLRF        main_cond3_L0+1 
;computador.c,908 :: 		trans = 1;
	MOVLW       1
	MOVWF       main_trans_L0+0 
;computador.c,910 :: 		addr++;
	INCF        main_addr_L0+0, 1 
;computador.c,911 :: 		SEQ_NUMBER =0;
	CLRF        _SEQ_NUMBER+0 
;computador.c,912 :: 		}
L_main74:
;computador.c,914 :: 		if(addr > 0xFF){
	MOVF        main_addr_L0+0, 0 
	SUBLW       255
	BTFSC       STATUS+0, 0 
	GOTO        L_main77
;computador.c,915 :: 		trans = 3;
	MOVLW       3
	MOVWF       main_trans_L0+0 
;computador.c,916 :: 		}
L_main77:
;computador.c,918 :: 		if(ch_cond == 100){
	MOVLW       0
	XORWF       main_ch_cond_L0+1, 0 
	BTFSS       STATUS+0, 2 
	GOTO        L__main113
	MOVLW       100
	XORWF       main_ch_cond_L0+0, 0 
L__main113:
	BTFSS       STATUS+0, 2 
	GOTO        L_main78
;computador.c,919 :: 		if(ch == 26){
	MOVF        _ch+0, 0 
	XORLW       26
	BTFSS       STATUS+0, 2 
	GOTO        L_main79
;computador.c,920 :: 		ch = 11;
	MOVLW       11
	MOVWF       _ch+0 
;computador.c,921 :: 		ch_cond = 0;
	CLRF        main_ch_cond_L0+0 
	CLRF        main_ch_cond_L0+1 
;computador.c,922 :: 		}
	GOTO        L_main80
L_main79:
;computador.c,924 :: 		ch++;
	INCF        _ch+0, 1 
;computador.c,925 :: 		ch_cond = 0;
	CLRF        main_ch_cond_L0+0 
	CLRF        main_ch_cond_L0+1 
;computador.c,926 :: 		}
L_main80:
;computador.c,927 :: 		Initialize();                      // Initialize MCU and Bee click board
	CALL        _Initialize+0, 0
;computador.c,928 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;computador.c,929 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;computador.c,930 :: 		}
L_main78:
;computador.c,932 :: 		if(trans == 0){
	MOVF        main_trans_L0+0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main81
;computador.c,933 :: 		Lcd_Chr(2,5,'b');
	MOVLW       2
	...
	CALL        _Lcd_Chr+0, 0
;computador.c,934 :: 		if(Debounce_INT() == 0 ){
	CALL        _Debounce_INT+0, 0
	MOVF        R0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main82
;computador.c,935 :: 		temp1 = read_ZIGBEE_short(INTSTAT); // Read and flush register INTSTAT
	MOVLW       49
	MOVWF       FARG_read_ZIGBEE_short_address+0 
	CALL        _read_ZIGBEE_short+0, 0
	MOVF        R0, 0 
	MOVWF       _temp1+0 
;computador.c,936 :: 		read_RX_FIFO();                     // Read receive data
	CALL        _read_RX_FIFO+0, 0
;computador.c,937 :: 		d1=DATA_RX[0];
	MOVF        _DATA_RX+0, 0 
	MOVWF       main_d1_L0+0 
;computador.c,938 :: 		d2=DATA_RX[1];
	MOVF        _DATA_RX+1, 0 
	MOVWF       main_d2_L0+0 
;computador.c,940 :: 		ch=DATA_RX[15];
	MOVF        _DATA_RX+15, 0 
	MOVWF       _ch+0 
;computador.c,941 :: 		cond = 1;
	MOVLW       1
	MOVWF       main_cond_L0+0 
;computador.c,942 :: 		ch_cond = 0;
	CLRF        main_ch_cond_L0+0 
	CLRF        main_ch_cond_L0+1 
;computador.c,944 :: 		}
	GOTO        L_main83
L_main82:
;computador.c,945 :: 		else if(cond > 0){
	MOVLW       128
	MOVWF       R0 
	MOVLW       128
...
L_main85:
	...
	DECFSZ      R12, 1, 0
	BRA         L_main85
;computador.c,947 :: 		cond ++;
	INCF        main_cond_L0+0, 1 
;computador.c,948 :: 		if(cond == 7){
	MOVF        main_cond_L0+0, 0 
	XORLW       7
	BTFSS       STATUS+0, 2 
	GOTO        L_main86
;computador.c,949 :: 		trans = 1;
	MOVLW       1
	MOVWF       main_trans_L0+0 
;computador.c,950 :: 		Initialize();                      // Initialize MCU and Bee click board
	CALL        _Initialize+0, 0
;computador.c,951 :: 		cond3 += 3;
	MOVLW       3
	ADDWF       main_cond3_L0+0, 1 
	MOVLW       0
	ADDWFC      main_cond3_L0+1, 1 
;computador.c,952 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;computador.c,953 :: 		Lcd_Chr(2,1,'b');
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;computador.c,954 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;computador.c,956 :: 		trans = 2;
	MOVLW       2
	MOVWF       main_trans_L0+0 
;computador.c,957 :: 		cond3 ++;
...
L_main88:
	...
	DECFSZ      R12, 1, 0
	BRA         L_main88
;computador.c,962 :: 		cond2++;
	INFSNZ      main_cond2_L0+0, 1 
	INCF        main_cond2_L0+1, 1 
;computador.c,963 :: 		Lcd_Chr(1,5,'C');
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       5
	MOVWF       FARG_Lcd_Chr_column+0 
...
L__main115:
	BTFSS       STATUS+0, 2 
	GOTO        L_main89
;computador.c,965 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;computador.c,966 :: 		Delay_ms(1);
	MOVLW       4
	MOVWF       R12, 0
	MOVLW       61
	MOVWF       R13, 0
L_main90:
	...
	NOP
	NOP
;computador.c,967 :: 		trans = 1;
	MOVLW       1
	MOVWF       main_trans_L0+0 
;computador.c,968 :: 		cond3 ++;
	INFSNZ      main_cond3_L0+0, 1 
	INCF        main_cond3_L0+1, 1 
;computador.c,969 :: 		}
L_main89:
...
;computador.c,971 :: 		}
L_main81:
;computador.c,973 :: 		if(trans == 1){
	MOVF        main_trans_L0+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_main91
;computador.c,974 :: 		Delay_ms(9);
	MOVLW       30
	MOVWF       R12, 0
	MOVLW       55
	MOVWF       R13, 0
L_main92:
	...
	DECFSZ      R12, 1, 0
	BRA         L_main92
;computador.c,976 :: 		DATA_TX[0]='3';
	MOVLW       51
	MOVWF       _DATA_TX+0 
;computador.c,977 :: 		DATA_TX[1]=dig2;
	MOVF        _dig2+0, 0 
	MOVWF       _DATA_TX+1 
;computador.c,978 :: 		DATA_TX[2]=dig3;
	MOVF        _dig3+0, 0 
	MOVWF       _DATA_TX+2 
;computador.c,979 :: 		DATA_TX[3]=degrees;
	MOVF        _degrees+0, 0 
	MOVWF       _DATA_TX+3 
;computador.c,980 :: 		DATA_TX[4]=battery;
	MOVF        _battery+0, 0 
	MOVWF       _DATA_TX+4 
;computador.c,981 :: 		write_TX_normal_FIFO();
	CALL        _write_TX_normal_FIFO+0, 0
;computador.c,982 :: 		i = read_ZIGBEE_short(TXSTAT);
	MOVLW       36
	MOVWF       FARG_read_ZIGBEE_short_address+0 
	CALL        _read_ZIGBEE_short+0, 0
	MOVF        R0, 0 
	MOVWF       main_i_L0+0 
;computador.c,984 :: 		ch_cond++;
	INFSNZ      main_ch_cond_L0+0, 1 
	INCF        main_ch_cond_L0+1, 1 
;computador.c,985 :: 		cond3 ++;
	INFSNZ      main_cond3_L0+0, 1 
	INCF        main_cond3_L0+1, 1 
;computador.c,986 :: 		SEQ_NUMBER++;
	INCF        _SEQ_NUMBER+0, 1 
;computador.c,988 :: 		if((i & 0b00000001) == 0){
	MOVLW       1
	ANDWF       R0, 0 
	MOVWF       R1 
	MOVLW       0
...
L__main116:
	BTFSS       STATUS+0, 2 
	GOTO        L_main93
;computador.c,989 :: 		trans = 0;
	CLRF        main_trans_L0+0 
;computador.c,990 :: 		cond = 0;
	CLRF        main_cond_L0+0 
;computador.c,991 :: 		cond2 = 0;
	CLRF        main_cond2_L0+0 
	CLRF        main_cond2_L0+1 
;computador.c,992 :: 		Initialize();
	CALL        _Initialize+0, 0
;computador.c,993 :: 		cond3 += 3;
	MOVLW       3
	ADDWF       main_cond3_L0+0, 1 
	MOVLW       0
	ADDWFC      main_cond3_L0+1, 1 
;computador.c,994 :: 		Lcd_Chr(1,1,'a');
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_column+0 
...
;computador.c,996 :: 		}
	GOTO        L_main94
L_main93:
;computador.c,997 :: 		else if((i & 1) == 1){
	MOVLW       1
	ANDWF       main_i_L0+0, 0 
	MOVWF       R1 
	MOVF        R1, 0 
	...
	BTFSS       STATUS+0, 2 
	GOTO        L_main95
;computador.c,998 :: 		Lcd_Cmd(_LCD_CLEAR);
	MOVLW       1
	MOVWF       FARG_Lcd_Cmd_out_char+0 
	CALL        _Lcd_Cmd+0, 0
;computador.c,999 :: 		Lcd_Chr(1,1,d1);
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_column+0 
	...
	MOVWF       FARG_Lcd_Chr_out_char+0 
	CALL        _Lcd_Chr+0, 0
;computador.c,1000 :: 		Lcd_Chr(1,2,d2);
	MOVLW       1
	MOVWF       FARG_Lcd_Chr_row+0 
	MOVLW       2
	MOVWF       FARG_Lcd_Chr_column+0 
...
L_main95:
L_main94:
;computador.c,1002 :: 		}   //final trans ==1
L_main91:
;computador.c,1003 :: 		if(trans == 2){
	MOVF        main_trans_L0+0, 0 
	XORLW       2
	BTFSS       STATUS+0, 2 
	GOTO        L_main96
;computador.c,1004 :: 		Delay_ms(9);
	MOVLW       30
	MOVWF       R12, 0
	MOVLW       55
	MOVWF       R13, 0
L_main97:
	...
	DECFSZ      R12, 1, 0
	BRA         L_main97
;computador.c,1005 :: 		cond3 ++;
	INFSNZ      main_cond3_L0+0, 1 
	INCF        main_cond3_L0+1, 1 
;computador.c,1006 :: 		}
L_main96:
;computador.c,1007 :: 		}//final while
	GOTO        L_main72
;computador.c,1008 :: 		}
	GOTO        $+0
; end of _main
